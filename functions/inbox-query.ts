...
export const inboxQuery = `SELECT i.watch_id,i.marketplace,i.marketplace_item_id,i.data,i.first_seen_at,i.last_seen_at,i.dismissed,l.data AS listing,w.revision
  ...
  LEFT JOIN finder_verdicts v ON v.watch_id=i.watch_id AND v.marketplace=i.marketplace AND v.marketplace_item_id=i.marketplace_item_id
  WHERE ($1='dismissed' AND i.dismissed OR $1='judged' AND v.verdict IS NOT NULL AND NOT i.dismissed
