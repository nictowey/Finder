...
| 2026-09-23 | [Sparse review probe #4](https://github.com/nictowey/Finder/actions/runs/35817392827) | The bounded sample again contained 22 distinct listings and reached each search cap. | One possible pressing lead, eight family review leads, 13 conflicts. Controlled conflict reasons: nine barcode, two color, two artist disagreements. These are seller-claim comparisons with the selected catalog release, not verified classifications. The selected color-pair listing remains `family_only` in the separate competing-release check. |
| 2026-09-23 | [Default target-plan probe #5](https://github.com/nictowey/Finder/actions/runs/35817625431) | The probe now uses the same generated query plan as `scan-target --release`: broad artist/title, seller-spelling alias, and optional complete color pair. Thirty fetched results represented 23 distinct listings, with seven overlaps; all three pages hit their cap. | One possible pressing lead, eight family review leads, 14 conflicts (nine barcode, three color, two artist). Compared with #4, the sample contains one more distinct listing and one more color conflict. No labels were manually verified; the selected pair listing is still `family_only` in the eight-release comparison. |
...
No real seller or listing values will be committed as labeled fixtures until provider use is
cleared.
